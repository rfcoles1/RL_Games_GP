...
weights = np.load('../../../Genetic_Algorithms/models/GP_Water-v0/86.npz')
...
def plt_model(ind, s, r):   
        ...
        plt.scatter(env.unwrapped.engine.get_Energy_From_Temp(env.unwrapped.engine.TargetT), self.unwrapped.engine.TargetT, marker = '*')
        ...
        plt.scatter(env.unwrapped.engine.get_Energy_From_Temp(env.unwrapped.engine.TargetT), self.unwrapped.engine.TargetM, marker = '*')
